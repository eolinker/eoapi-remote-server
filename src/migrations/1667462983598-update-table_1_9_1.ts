...
export class updateTable1911667462983598 implements MigrationInterface {
    name = 'updateTable1911667462983598'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`lastLoginTime\` timestamp NOT NULL`);
