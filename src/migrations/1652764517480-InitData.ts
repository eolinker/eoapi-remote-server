...
export class InitData1652764517480 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO api_data (uuid, name, projectID, groupID, uri, protocol, method, requestBodyType, requestBodyJsonType, queryParams, restParams, responseHeaders, responseBodyType, responseBodyJsonType, responseBody) VALUES ?`,
      [apiData],
    );
  }
